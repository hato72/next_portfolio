...
const basicInfo = {
  ...
  internships: [
    ...
    //     period: "1ヵ月間(週2,3日)",
    //     technologies: ["Go", "Gin", "Docker","AWS"],
    //     occupation: "バックエンドエンジニア",
    //     description: "自社プロダクトである「Visual QA」のバックエンドAPI開発開発に取り組んでいる。Visual QAは、画像を入力として受け取り、その画像に関する質問に対して回答を返すAIモデルを提供するサービスである。私はGoを用いてAPIの設計やテーブル作成、実装を行った。"
    // }
  ],
  hackathons: [
    {
